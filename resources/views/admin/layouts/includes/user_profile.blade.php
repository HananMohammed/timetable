    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            <div class="symbol symbol-100 mr-5">
                <div class="symbol-label" style="background-image:url({{asset('admin/assets/media/users/avatar.webp')}})"></div>
            ...
            <div class="d-flex flex-column">
                ...
                <div class="navi mt-2">
                    ...
                    <a target="_blank" href="#" class="btn btn-sm btn-light-primary font-weight-bolder py-2 px-5"
